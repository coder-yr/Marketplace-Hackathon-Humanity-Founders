    ...
    <div className="min-h-screen flex bg-[var(--surface-1)]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[var(--surface-2)]">
        ...
        <div className="relative z-10 p-12 flex flex-col justify-end h-full max-w-2xl">
          <div className="w-12 h-12 bg-[var(--color-brand-primary)] rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-[var(--color-brand-primary)]/30">
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Button
              ...
              size="lg"
              loading={isLoading}
              className="gradient-brand text-white shadow-lg shadow-[var(--color-brand-primary)]/20 hover:shadow-xl hover:shadow-[var(--color-brand-primary)]/30 hover:-translate-y-0.5 transition-all text-base font-semibold rounded-xl mt-4"
            >
